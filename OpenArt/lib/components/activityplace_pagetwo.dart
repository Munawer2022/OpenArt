...
class ActivityPlacePageTwo extends StatefulWidget {
  const ActivityPlacePageTwo({Key? key}) : super(key: key);

  @override
  State<ActivityPlacePageTwo> createState() => _ActivityPlacePageTwoState();
}

class _ActivityPlacePageTwoState extends State<ActivityPlacePageTwo> {
  @override
