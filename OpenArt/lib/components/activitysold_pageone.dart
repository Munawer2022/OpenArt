...
class ActivitySoldPageone extends StatefulWidget {
  const ActivitySoldPageone({Key? key}) : super(key: key);

  @override
  State<ActivitySoldPageone> createState() => _ActivitySoldPageoneState();
}

class _ActivitySoldPageoneState extends State<ActivitySoldPageone> {
  @override
