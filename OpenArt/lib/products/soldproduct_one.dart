...
class SoldProductOne extends StatefulWidget {
  const SoldProductOne({Key? key}) : super(key: key);

  @override
  State<SoldProductOne> createState() => _SoldProductOneState();
}

class _SoldProductOneState extends State<SoldProductOne> {
  bool isFollow = true;
  @override
