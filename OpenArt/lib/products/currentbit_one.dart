...
class CurrentBitOne extends StatefulWidget {
  const CurrentBitOne({Key? key}) : super(key: key);

  @override
  State<CurrentBitOne> createState() => _CurrentBitOneState();
}

class _CurrentBitOneState extends State<CurrentBitOne> {
  bool isFollow = true;
  @override
  void initState() {
