...
class CurrentBitTwo extends StatefulWidget {
  const CurrentBitTwo({Key? key}) : super(key: key);

  @override
  State<CurrentBitTwo> createState() => _CurrentBitTwoState();
}

class _CurrentBitTwoState extends State<CurrentBitTwo> {
  bool isFollow = true;
  @override
  void initState() {
