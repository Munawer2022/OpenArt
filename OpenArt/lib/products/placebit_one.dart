...
import 'package:open_art2/components/activityplace_pagetwo.dart';
...
class PlaceBitOne extends StatefulWidget {
  const PlaceBitOne({Key? key}) : super(key: key);

  @override
  State<PlaceBitOne> createState() => _PlaceBitOneState();
}

class _PlaceBitOneState extends State<PlaceBitOne> {
  bool isFollow = true;
  @override
